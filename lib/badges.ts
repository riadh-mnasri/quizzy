...
export const BADGES: Badge[] = [
  ...
  },
  {
    ...
    check: (s) => allChaptersMastered(s, "maths-cm1"),
  },
  {
    ...
    check: (s) => allChaptersMastered(s, "francais-cm1"),
  },
  {
    ...
    check: (s) => allChaptersMastered(s, "anglais-cm1"),
  },
  {
  ...
  },
  {
    ...
    name: "Polyvalent",
    icon: "🌈",
    description: "Les 3 matières pratiquées le même jour",
